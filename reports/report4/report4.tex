...
\begin{document}
  ...
  \subsection{Scalable}
    ...
    (this will eventually not speedup anymore, because there is not enough work
    to occupy all the worker nodes).
    ...
    \begin{table}[H]
	    ...
	    \begin{center}
		    \begin{tabular}{| c | c | c | c | c | c |}
			    \hline
			    Sequential & 1 Node in total & 2 Nodes in total & 4 Nodes in total & 8 Nodes in total & 16 Nodes in total\\ 
			    \hline
			    a & b & c & d & e & f\\
			    \hline
			    a & b & c & d & e & f\\
