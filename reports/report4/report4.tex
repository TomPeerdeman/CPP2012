...
\begin{document}
  ...
  \subsection{Discussion}
    ...
    parallalization only works onto a certai point when it comes to faster
    computations.
  \subsection{Optimization}
    The easiest way to get an even higher speedup is to add more worker nodes.
    There will however be a limit to the amount of workers a program can need.
    %TODO more ways to optimize
